...
import {fetchTransactions, fetchTransactionSummary} from '../api/transaction';
...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        fetchTransactionSummary(userId, token).then(res => {
            setSummary({
        ...
        fetchTransactions(userId, undefined, undefined, token).then(res => {
            ...
            fetchGoals(userId, token).then(res => {
